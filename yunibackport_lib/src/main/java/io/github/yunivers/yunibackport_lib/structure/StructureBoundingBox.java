...
public class StructureBoundingBox
{
    ...
    public static StructureBoundingBox getComponentToAddBoundingBox(int x, int y, int z, int n4, int n5, int n6, int n7, int n8, int n9, int type)
    {
        return switch (type) {
            case 2 ->
                    new StructureBoundingBox(x + n4, y + n5, z - n9 + 1 + n6, x + n7 - 1 + n4, y + n8 - 1 + n5, z + n6);
            case 0, 3 ->
                    new StructureBoundingBox(x + n4, y + n5, z + n6, x + n7 - 1 + n4, y + n8 - 1 + n5, z + n9 - 1 + n6);
            case 1 ->
                    new StructureBoundingBox(x - n9 + 1 + n6, y + n5, z + n4, x + n6, y + n8 - 1 + n5, z + n7 - 1 + n4);
            default ->
                    new StructureBoundingBox(x + n6, y + n5, z + n4, x + n9 - 1 + n6, y + n8 - 1 + n5, z + n7 - 1 + n4);
        };
    }
