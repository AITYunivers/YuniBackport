...
public class NetherFortressComponentCorridor5 extends NetherFortressComponentPiece
{
    public NetherFortressComponentCorridor5(int n, Random random, StructureBoundingBox structureBoundingBox, int n2) {
        super(n);
    ...
    public static NetherFortressComponentCorridor5 func_40032_a(List<StructureComponent> list, Random random, int n, int n2, int n3, int n4, int n5) {
        StructureBoundingBox structureBoundingBox = StructureBoundingBox.getComponentToAddBoundingBox(n, n2, n3, -1, 0, 0, 5, 7, 5, n4);
        if (!NetherFortressComponentCorridor5.func_40021_a(structureBoundingBox) || StructureComponent.getIntersectingStructureComponent(list, structureBoundingBox) != null) {
            return null;
        }
        return new NetherFortressComponentCorridor5(n5, random, structureBoundingBox, n4);
    }
