...
public class NetherFortressComponentCrossing2 extends NetherFortressComponentPiece
{
    public NetherFortressComponentCrossing2(int n, Random random, StructureBoundingBox structureBoundingBox, int n2) {
        super(n);
    ...
    public void buildComponent(StructureComponent structureComponent, List<StructureComponent> list, Random random) {
        ...
        this.func_40016_c((NetherFortressComponentStartPiece)structureComponent, list, random, 0, 1, true);
    }

    public static NetherFortressComponentCrossing2 func_40025_a(List<StructureComponent> list, Random random, int n, int n2, int n3, int n4, int n5) {
        StructureBoundingBox structureBoundingBox = StructureBoundingBox.getComponentToAddBoundingBox(n, n2, n3, -1, 0, 0, 5, 7, 5, n4);
        if (!NetherFortressComponentCrossing2.func_40021_a(structureBoundingBox) || StructureComponent.getIntersectingStructureComponent(list, structureBoundingBox) != null) {
            return null;
        }
        return new NetherFortressComponentCrossing2(n5, random, structureBoundingBox, n4);
    }
    ...
    public boolean addComponentParts(World world, Random random, StructureBoundingBox structureBoundingBox) {
        ...
        this.fillWithBlocks(world, structureBoundingBox, 0, 2, 4, 0, 5, 4, YuniBackport_r0.BLOCK_NETHER_BRICK.id, YuniBackport_r0.BLOCK_NETHER_BRICK.id, false);
        this.fillWithBlocks(world, structureBoundingBox, 4, 2, 4, 4, 5, 4, YuniBackport_r0.BLOCK_NETHER_BRICK.id, YuniBackport_r0.BLOCK_NETHER_BRICK.id, false);
